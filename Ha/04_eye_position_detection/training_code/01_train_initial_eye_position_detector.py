...
DATA_ZIP = ROOT / "converted_eye_1class" / "eye_mixed_1class_eye.zip"
PREPARED_DIR = ROOT / "converted_eye_1class" / "prepared_eye_mixed_1class"
...
def train(args: argparse.Namespace) -> None:
    """YOLOv8n eye detector를 mixed 1클래스 데이터셋으로 1차 학습한다."""
    ...
    report = {
        ...
        "model": "yolov8n",
        "dataset": "eye_mixed_awake_sleep_1class",
        "imgsz": args.imgsz,
        "epochs": args.epochs,
    ...
    (REPORT_DIR / "mixed_eye_detector_summary.json").write_text(
